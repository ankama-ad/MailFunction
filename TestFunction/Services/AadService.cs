...
namespace AppOwnsData.Services
{
    ...
    {
        //private static IConfigurationRoot configuration = Environment.GetEnvironmentVariable("SqlConnectionString");
        private static readonly string m_authorityUrl = Environment.GetEnvironmentVariable("authorityUrl");
        private static readonly string[] m_scope = Environment.GetEnvironmentVariable("scope").Split(';');
